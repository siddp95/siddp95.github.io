...
Welcome to my personal analytics portfolio! My name is Siddarth and I'm a Big Data professional with 5 years of experience at Northrop Grumman, an M.S. in Analytics from Georgia Tech, and B.S. in Statistics from UC Riverside. I’m passionate about uncovering hidden patterns in data and transforming raw numbers into actionable insights and thrive on turning complex data into clear, strategic narratives that are understandable to all audiences, both technical and non-technical.
